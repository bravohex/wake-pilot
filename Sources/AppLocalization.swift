...
enum AppStrings {
    ...
    private static let catalogs: [AppLanguage: [Key: String]] = [
        .vietnamese: [
            ...
            .loginNotFound: "App cần được cài trong thư mục Applications",
        ...
        .english: [
            ...
            .loginNotFound: "The app must be installed in Applications",
        ...
        .japanese: [
            ...
            .loginDisabled: "無効",
            .loginNotFound: "アプリはApplicationsフォルダにインストールする必要があります",
            .loginUnknown: "不明",
